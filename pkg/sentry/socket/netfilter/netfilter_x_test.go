...
// istioBlob is a golden iptables NAT ruleset generated by Istio. It is already
// in the format ready to by passed to IPT_SO_SET_REPLACE.
//
...
// acceptBlob is a golden iptables NAT ruleset that instructs iptables to
// ACCEPT all and modify nothing. This is the Linux default: a newly booted
// machine just doesn't NAT anything until someone sets the rules.
//
// Updating this requires running Istio, calling IPT_SO_GET_INFO and
// IPT_SO_GET_ENTRIES, then stitching the structs up. So be careful when
// updating!
