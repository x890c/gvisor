...
// Execution represents the result of executing a BPF program.
...
func (e *Execution) markInputRead(offset uint32, bytesRead int) {
...
func InstrumentedExec(p Program, in Input) (Execution, error) {
	ret := Execution{
