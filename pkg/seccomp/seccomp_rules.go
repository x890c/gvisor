...
func (me maskedEqual) Split() (HalfValueMatcher, HalfValueMatcher) {
	highMatcher := HalfValueMatcher(halfMaskedEqual{high32Bits(me.mask), high32Bits(me.value)})
	lowMatcher := HalfValueMatcher(halfMaskedEqual{low32Bits(me.mask), low32Bits(me.value)})
